    ...
    <div className="max-w-10xl mx-auto px-6 mt-4 pb-10">
      <div className="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-5 text-zinc-900 dark:text-zinc-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-5">
          {/* Complexity */}
          <div className="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 p-4 text-zinc-900 dark:text-zinc-100">
            ...
            <div className="mt-3 text-sm space-y-2">
              <div className="flex justify-between gap-3">
                ...
                <span className="font-mono text-zinc-900 dark:text-zinc-100">{meta.time.best}</span>
              </div>
              <div className="flex justify-between gap-3">
                <span className="text-zinc-600 dark:text-zinc-400">Average</span>
                <span className="font-mono text-zinc-900 dark:text-zinc-100">{meta.time.average}</span>
              </div>
              <div className="flex justify-between gap-3">
                <span className="text-zinc-600 dark:text-zinc-400">Worst</span>
                <span className="font-mono text-zinc-900 dark:text-zinc-100">{meta.time.worst}</span>
              </div>
              <div className="flex justify-between gap-3 pt-2 border-t border-zinc-200 dark:border-zinc-800">
                <span className="text-zinc-600 dark:text-zinc-400">Space</span>
                <span className="font-mono text-zinc-900 dark:text-zinc-100">{meta.space}</span>
              </div>
            </div>
          </div>
